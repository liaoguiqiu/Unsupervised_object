...
class Decoder(nn.Module):
    def __init__(self, hid_dim, resolution):
        ...
        self.conv6 = nn.ConvTranspose2d(hid_dim, 384 +1, 3, stride=(1, 1) )
...
class SlotAttentionAutoEncoder(nn.Module):
    def __init__(self, resolution, num_slots, num_iterations, hid_dim,
        ...
        self.decoder_cnn_dino = Decoder(384, self.resolution)


        self.fc1 = nn.Linear(hid_dim, hid_dim)
        self.fc2 = nn.Linear(hid_dim, hid_dim)
        self.fc1_dino = nn.Linear(384, 384)
        self.fc2_dino = nn.Linear(384, 384)
    ...
    def forward(self, image):
        ...
        slots_dino = slots_dino.repeat((1, 8, 8, 1))
